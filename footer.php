					...
					<div class="row">
						...
						<div class="cell-6">
							<form action="https://konjure.us18.list-manage.com/subscribe/post?u=18cb115074434e89c25c67493&amp;id=45b0aabe6d" method="POST" name="mc-embedded-subscribe-form">
								...
								<input type="email" name="EMAIL" id="footer-input" placeholder="satoshi.nakamoto@gmail.com" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required>
