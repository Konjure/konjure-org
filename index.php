...
<html>
	...
	<head>
		...
		<meta name="description" content="Konjure streamlines the process from site creation to hosting on a decentralized, peer-to-peer network. By utilizing blockchain technology, we're providing a gateway for mass adoption of the Decentralized Web."/>
		<meta name="keywords" content="konjure, website builder, blockchain, decentralized, decentralization, token, konj, development, shop, blog"/>
	...
	<body>
		...
		<div class="splash">
			<div class="cover">
				<div class="grid no-margin no-padding">
					<div class="cell-8 left">
						<div class="vertical-center-outer">
							<div class="vertical-center-inner">
								<h1 data-sr="enter left, and hustle 20px">The website builder <br><span>of the <strong>blockchain</strong></span></h1>
								<br>
								<form action="https://konjure.us18.list-manage.com/subscribe/post?u=18cb115074434e89c25c67493&amp;id=45b0aabe6d" method="POST" name="mc-embedded-subscribe-form" data-sr="enter left, and hustle 20px">
									<i class="fa fa-envelope" id="splash-icon"></i>
									<input type="email" name="EMAIL" id="splash-input" placeholder="satoshi.nakamoto@gmail.com" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required>
									<button type="submit" id="splash-submit" hover="brighten">
					...
					<div class="cell-8 right">
						<img src="assets/media/images/shadow.png" class="no-select" id="shadow"/>
						<img src="assets/media/images/cauldron.svg" class="no-select" id="cauldron"/>
						<img src="assets/media/images/ghost.svg" class="no-select" id="ghost"/>
						<img src="assets/media/images/bubble_1.svg" class="no-select" id="bubble1"/>
						<img src="assets/media/images/bubble_2.svg" class="no-select" id="bubble2"/>
						<img src="assets/media/images/bubble_3.svg" class="no-select" id="bubble3"/>
						<img src="assets/media/images/bubble_3.svg" class="no-select" id="bubble4"/>
						<img src="assets/media/images/bubble_3.svg" class="no-select" id="bubble5"/>
						<img src="assets/media/images/bubble_3.svg" class="no-select" id="bubble6"/>
						<img src="assets/media/images/smoke_1.svg" class="no-select" id="smoke1"/>
						<img src="assets/media/images/smoke_2.svg" class="no-select" id="smoke2"/>
					</div>
				</div>
			</div>
			<div class="splash-bottom gradient" id="header-trigger"></div>
		</div>
		
		<div class="section graphic-section">
			...
			<div class="cover">
				<div class="grid no-padding">
					<div class="cell-8">
						<div class="vertical-center-outer">
							<div class="vertical-center-inner">
								<img src="assets/media/images/graphic-web.svg" class="no-select"/>
							</div>
						</div>
					</div>
							...
							<div class="vertical-center-inner">
								...
								<a href="/get-started/what-is-konjure">
									<div class="kbutton" hover="brighten" data-sr="enter right, and hustle 20px">
										<div class="kbutton-left">Explore Konjure</div>
		...
		<div class="section graphic-section sec-right">
			<div class="gradient-cover"></div>
			<div class="cover">
				<div class="grid no-padding">
					<div class="cell-8">
						<div class="vertical-center-outer">
							<div class="vertical-center-inner">
								...
								<br><br>
								<h3 data-sr="enter left, and hustle 20px">Build, launch, and maintain your website with the power of KONJ, our versatile utility token. Earn node rewards, purchase plugins from developers, and much more.</h3>
								<br><br>
								<a href="/get-started/token">
									<div class="kbutton" hover="brighten" data-sr="enter left, and hustle 20px">
										<div class="kbutton-left">Learn More</div>
										<div class="kbutton-right"><i class="fa fa-chevron-right"></i></div>
									</div>
								</a>
							</div>
					...
					<div class="cell-8">
						<div class="vertical-center-outer">
							<div class="vertical-center-inner">
								<img src="assets/media/images/graphic-dev.svg" class="right no-select"/>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="cover">
				<div class="feature-cover">
					<div class="feature-icon">
						<img src="assets/media/images/cauldron-empty-40.png" class="no-select" id="cauldron-icon"/>
					</div>
					<div class="feature-animation-cover">
						<div class="featureanimations">
							<img src="assets/media/images/dark-ghost.svg" class="animatedtoken"/>
						</div>
					</div>
				</div>
				...
				<div class="grid no-padding">
					<div class="row">
						<div class="cell-8">
							<h2 data-sr="enter left, and hustle 20px">Downtime</h2>
							<br>
							<h3 data-sr="enter left, and hustle 20px">The Konjure network is maintained by our community of nodes, operated by individuals around the globe. Website files are served by the closest available peers, and there are no physical servers to act as single points of failure. This ensures that DDoS attacks, hardware malfunctions, and data center conflicts are issues of the past. Website downtime will become a distant memory.</h3>
							<br>
							<h3 data-sr="enter left, and hustle 20px"><a href="/get-started/roadmap">Roadmap <i class="fa fa-angle-right"></i></a></h3>
						</div>
						<div class="cell-8 text-right">
							<h2 data-sr="enter right, and hustle 20px">Web Hosting Costs</h2>
							<br>
							<h3 data-sr="enter right, and hustle 20px">By choosing to allocate a set limit of CPU, memory, and network speed, users can run a node and become part of the file storage system. In return, they receive KONJ as a reward, which can be used to host their website and be spent throughout the ecosystem. This model disrupts the web hosting industry, allowing users to allocate their spare resources to cut the costs of hosting their own website.</h3>
							<br>
							<h3 data-sr="enter right, and hustle 20px"><a href="/company/papers/konjure-whitepaper.pdf" target="_blank"><i class="fa fa-angle-left"></i> Whitepaper</a></h3>
						</div>
					</div>
					<div class="row">
						<div class="cell-8">
							<h2 data-sr="enter left, and hustle 20px">Ownership</h2>
							<br>
							<h3 data-sr="enter left, and hustle 20px">Acting as a portal to the Decentralized Web, Konjure empowers anyone to build an online presence free from both government and corporate authority. Not even the core Konjure development team has access to modify user websites. As the sole owners of their data, users in all parts of the world can speak freely without any chance of censorship.</h3>
							<br>
							<h3 data-sr="enter left, and hustle 20px"><a href="/development/decentralization">Decentralization <i class="fa fa-angle-right"></i></a></h3>
						</div>
						<div class="cell-8 text-right">
							<h2 data-sr="enter right, and hustle 20px">Templates</h2>
							<br>
							<h3 data-sr="enter right, and hustle 20px">On existing website builders you are forced to either use a template that is already live on a multitude of other websites, or hire a developer to design a custom theme for you, which can be costly. Konjure GEN will enable users to procedurally generate websites based on their industry, preferred style, color scheme, and other suggestions. This ensures that each new design is unique and built specifically for the user.</h3>
							<br>
							<h3 data-sr="enter right, and hustle 20px"><a href="/development/overview"><i class="fa fa-angle-left"></i> Development Overview</a></h3>
						</div>
					</div>
				</div>
			</div>
			<img src="assets/media/images/graphic-ai.svg" id="features-backpic"/>
		</div>
