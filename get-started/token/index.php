...
<html>
	...
	<head>
		...
		<meta name="description" content="The KONJ utility token acts as the primary cryptocurrency in our ecosystem of websites. Users can build their online presence, purchase plugins on our Bazaar, and much more."/>
		<meta name="keywords" content="konjure, website builder, konj, token, price, ecosystem, use cases, cardano, presale, sale, utility"/>
						...
						<div class="cell text-center">
							<div class="vertical-center-outer">
								<div class="vertical-center-inner">
									<img src="../../assets/media/images/coin.png" class="center no-select"/>
									<h1 data-sr="enter top, and hustle 20px">Introducing <strong>KONJ</strong></h1>
									<h3 data-sr="enter top, and hustle 20px">A utility token for use inside the Konjure ecosystem</h3>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="grid no-padding">
					...
					<div class="row">
						<div class="cell-10">
							...
							<h3 class="text-right" data-sr="enter right, and hustle 20px">15,000,000 KONJ</h3>
							<div class="divider"></div>
							<h3 data-sr="enter left, and hustle 20px"><i class="fa fa-circle color-seven"></i> 2% &middot; Bounty</h3>
							<h3 class="text-right" data-sr="enter right, and hustle 20px">15,000,000 KONJ</h3>
						</div>
						<div class="cell-6">
							<br>
					...
					<div class="cell text-right">
						<div class="vertical-center-outer">
							<div class="vertical-center-inner">
								...
								<br><br>
								<h3 data-sr="enter right, and hustle 20px">We share a vision for the future with the Cardano Foundation and feel confident building our token on their platform. Konjure will be one of the first coin offerings on Cardano, as our 2018 roadmap falls in line with theirs.</h3>
								<br><br>
			...
			<div class="cover">
				<div class="grid no-padding">
							...
							<div class="vertical-center-inner">
								...
								<a href="/get-started/roadmap">
									<div class="kbutton" hover="brighten" data-sr="enter left, and hustle 20px">
										<div class="kbutton-left">View Roadmap</div>
										<div class="kbutton-right"><i class="fa fa-chevron-right"></i></div>
									</div>
								</a>
							</div>
					...
					<div class="cell-8">
						<div class="vertical-center-outer">
							<div class="vertical-center-inner">
								<img src="../../assets/media/images/graphic-coins.png" class="right no-select"/>
							</div>
						</div>
					</div>
				</div>
