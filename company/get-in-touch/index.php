	...
	<body>
			...
			<div class="cover">
				...
				<div class="grid text-center">
					<div class="cell">
						...
						<h4><a href="https://twitter.com/konjureorg" target="_blank">Twitter</a></h4>
						<br>
					</div>
					<div class="cell">
						<br>
						<i class="fab fa-medium-m"></i>
						<h4><a href="https://medium.com/konjure" target="_blank">Medium</a></h4>
						<br>
					</div>
					<div class="cell">
						<br>
						<i class="fab fa-telegram-plane"></i>
						<h4><a href="https://t.me/konjure" target="_blank">Telegram</a></h4>
						<br>
					</div>
					<div class="cell">
						<br>
						<i class="fab fa-github"></i>
						<h4><a href="https://github.com/konjure" target="_blank">Github</a></h4>
						<br>
					</div>
					<div class="cell">
						<br>
						<i class="fab fa-reddit-alien"></i>
						<h4><a href="https://reddit.com/r/konjure" target="_blank">Reddit</a></h4>
						<br>
					</div>
				</div>
			</div>
		...
		<div class="section presskit dark">
			<div class="cover text-center">
				...
				<div class="grid no-padding">
					<div class="cell">
						<h2 data-sr="enter top, and hustle 20px">Logo Kit</h2>
						<br>
						<img src="../../assets/media/images/logo.svg" class="no-select"/>
						<a href="../../assets/media/images/konjure-logos.zip">
							<div class="zip" hover="brighten rise">Download ZIP</div>
						</a>
					</div>
					<div class="cell">
						<h2 data-sr="enter top, and hustle 20px">Graphic Kit</h2>
						<br>
						<img src="../../assets/media/images/graphic-web.svg" class="no-select"/>
						<a href="../../assets/media/images/konjure-graphics.zip">
							<div class="zip" hover="brighten rise">Download ZIP</div>
						</a>
					</div>
				</div>
			...
			<div class="cover">
				...
				<div class="grid no-padding">
					<div class="cell-10">
						<div class="vertical-center-outer">
							<div class="vertical-center-inner">
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3005.0263618237946!2d-104.81650658494267!3d41.13395047928822!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x876f3ac24cf6ff83%3A0xfc721fd93d978e07!2s109+E+17th+St+%235526%2C+Cheyenne%2C+WY+82001!5e0!3m2!1sen!2sus!4v1528924422165" class="no-select" width="100%" height="250" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>
					</div>
					...
					<div class="cell-5 text-right">
						<div class="vertical-center-outer">
							<div class="vertical-center-inner">
								<h3 data-sr="enter right, and hustle 20px">Feel free to send us a nice handwritten letter. Or some snacks. Preferrably snacks.</h3>
								<br>
								<em>
									<h3 data-sr="enter right, and hustle 20px">Konjure LLC</h3>
									<h3 data-sr="enter right, and hustle 20px">109 E. 17th St. #5526</h3>
									<h3 data-sr="enter right, and hustle 20px">Cheyenne, WY 82001</h3>
								</em>
								<br>
								<h5 data-sr="enter right, and hustle 20px"><strong>Note:</strong> This is a virtual office.</h3>
							</div>
						</div>
					</div>
				</div>
