...
<html>
	...
	<head>
		...
		<title>Subscription Success - Konjure</title>
		
		<meta charset="UTF-8">
		
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		
		<meta name="description" content="Success! You've subscribed to the Konjure newsletter."/>
		<meta name="keywords" content="konjure, website builder, success, newsletter"/>
	...
	<body>
		...
		<div class="section subscribe">
			<div class="cover">
				<h1 data-sr="enter left, and hustle 20px" id="header-trigger"><span>Success!</span></h1>
				<h3 data-sr="enter left, and hustle 20px">You've subscribed to Konjure's newsletter. We'll only send you the important stuff, promise.</h3>
				<br><br>
				<a href="https://konjure.org">
					<div class="kbutton" hover="brighten" data-sr="enter left, and hustle 20px">
						<div class="kbutton-left">Return Home</div>
