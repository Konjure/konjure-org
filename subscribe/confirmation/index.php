...
<html>
	...
	<head>
		...
		<title>Subscription Confirmation - Konjure</title>
		
		<meta charset="UTF-8">
		
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		
		<meta name="description" content="Confirm your subscription to our newsletter."/>
		<meta name="keywords" content="konjure, website builder, subscribe, newsletter"/>
	...
	<body>
		...
		<div class="section subscribe">
			<div class="cover">
				<h1 data-sr="enter left, and hustle 20px" id="header-trigger">Almost there...</h1>
				<h3 data-sr="enter left, and hustle 20px">We just need to confirm your subscription. Please check your email for instructions.</h3>
				<br><br>
